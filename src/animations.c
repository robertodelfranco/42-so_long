...
/*   Updated: 2025/02/17 15:17:01 by rdel-fra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->dead->dead_text[0] = mlx_load_png("textures/dead_0.png");
	...
	game->dead->dead_text[5] = mlx_load_png("textures/dead_5.png");
	game->dead->dead_img[5] = mlx_texture_to_image(game->mlx,
			game->dead->dead_text[5]);
